<template>
  <form
    ...
    class="w-96"
  >
    <h3 class="text-lg font-medium">Show us your past adventures</h3>
    ...
    <div
      ...
      :class="[
        isDragging ? 'border-emerald-500' : 'border-dashed border-neutral-300'
      ]"
    >
      <div class="space-y-1 text-center">
        ...
        <div class="flex text-sm text-neutral-600">
          <label
            for="file-upload"
            class="cursor-pointer rounded-md bg-white font-medium text-emerald-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-emerald-600 focus-within:ring-offset-2 hover:text-emerald-500"
          >
    ...
    <div class="mx-auto mt-6 flex flex-wrap gap-3">
      <div
        ...
        :key="image.name"
        class="group relative overflow-clip rounded-sm"
      >
        <img
          :src="imageUrl(image)"
          alt=""
...
const getValues = () =>
  document.getElementById('add-images-form').requestSubmit()
