<template>
  <label :for="props.name" class="group relative cursor-pointer">
    <input
      ...
      :class="maxWidth"
      min="1"
      class="peer ml-5 w-full border-0 py-0 text-[1.075rem] font-semibold valid:translate-y-3 valid:text-black focus-within:translate-y-3  focus-within::outline-none focus-within:ring-0"
    />
    <div
...
const maxWidth = props.inputType == 'number' ? 'max-w-[70px]' : 'max-w-[160px]'
</script>
